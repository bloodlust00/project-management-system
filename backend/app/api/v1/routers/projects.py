...
@router.post("/", response_model=APIResponse[ProjectResponse], dependencies=[Depends(PermissionChecker(["project:create"]))])
...
async def get_project(
    ...
    return APIResponse[ProjectResponse](
        success=True,
        message="Project details resolved successfully",
        data=ProjectResponse.model_validate(project)
    )

@router.put("/{project_id}", response_model=APIResponse[ProjectResponse], dependencies=[Depends(PermissionChecker(["project:update"]))])
...
@router.delete("/{project_id}", response_model=APIResponse, dependencies=[Depends(PermissionChecker(["project:delete"]))])
