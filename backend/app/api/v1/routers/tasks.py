...
async def create_task(
    ...
    return APIResponse[TaskResponse](
        success=True, message="Task created successfully", data=TaskResponse.model_validate(task)
    )
...
async def get_task_details(
    ...
    return APIResponse[TaskResponse](
        success=True, message="Task details resolved successfully", data=TaskResponse.model_validate(task)
    )
...
async def update_task(
    ...
    return APIResponse[TaskResponse](
        success=True, message="Task updated successfully", data=TaskResponse.model_validate(updated_task)
    )
...
async def export_tasks_csv(project_id: Optional[uuid.UUID] = Query(None), db: AsyncSession = Depends(get_db)):
